      ...
      >
        <View style={styles.header}>
          <View style={styles.headerTop}>
            ...
            <TouchableOpacity style={styles.aiButton} onPress={goToAIConsultant}>
              <Text style={styles.aiButtonText}>🤖 AI 상담</Text>
            </TouchableOpacity>
          </View>
          <Text style={styles.headerSubtitle}>총 {allReviews.length}개의 후기</Text>
        </View>
